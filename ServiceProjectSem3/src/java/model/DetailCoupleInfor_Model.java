 ...
 * @author Long
 */
public class DetailCoupleInfor_Model {
    ...
    private Date start;
    public DetailCoupleInfor_Model() {
    }

    public DetailCoupleInfor_Model(int myuserID, String myname, String mygmail, String myimage, int partneruserID, String partnername, String partnergmail, String partnerimage, int coupleId, String coupleImage, Date start) {
